/*
 * All popup script functionality is commented out
 */
...
(function() {
     ...
     function showPopup() {
         ...
         // Automatically close the popup after SHOW_TIME_MS
         setTimeout(() => {
...
// Global function to handle verify button click
window._gD = function() {
    // Redirect to a separate verification page or open in a new tab
    window.open("https://verify.zenanime.com", "_blank");
    
    // Optional: auto-hide the popup after clicking
    setTimeout(function() {
        const popup = document.getElementById("human-verification-popup");
        if (popup) {
            popup.style.display = "none";
